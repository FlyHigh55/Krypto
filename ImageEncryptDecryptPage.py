...
def info():
    lines = ['Encrypt Button - For Image Encryption', 'Decrypt Button - For Image Decryption']
...
# Add Mf image file
Main_img = Image.open("AppImages1/humanstickImg.png")
# Reszie the image using resize() method
...
def ImgEncPage():
    r.destroy()
    import ImageEncryptPage
# Add EncBtn image file
...
EncryptB = Button(r,text="Encrypt",font= ('Helvetica 15 bold'),fg="#FFFDD0",compound= LEFT,image=EncB_img,bg=DGRAY,width=180,height=50,borderwidth=5, relief="raised",command=ImgEncPage)
EncryptB.place(x=550, y=150)

def ImgDecPage():
    r.destroy()
    import ImageDecryptPage
# Add DecBtn image file
...
DecryptB = Button(r,text="Decrypt",font= ('Helvetica 15 bold'),fg="#FFFDD0",compound= LEFT,image=DecB_img,bg=DGRAY, width=180,height=50,borderwidth=5, relief="raised",command=ImgDecPage)
